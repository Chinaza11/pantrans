# -*- coding: utf-8 -*-
"""
Created on Fri Dec  8 22:37:03 2023
...
ChiAmber = pd.read_table("data/stable_ids/ChineseAmber.assign_stable_IDs", names=header)
Grassl = pd.read_table("data/stable_ids/Grassel.assign_stable_IDs", names=header)
Leoti = pd.read_table("data/stable_ids/Leoti.assign_stable_IDs", names=header)
pi229841 = pd.read_table("data/stable_ids/pi229841.assign_stable_IDs", names=header)
pi297155 = pd.read_table("data/stable_ids/pi297155.assign_stable_IDs", names=header)
pi329311 = pd.read_table("data/stable_ids/pi329311.assign_stable_IDs", names=header)
pi506069 = pd.read_table("data/stable_ids/pi506069.assign_stable_IDs", names=header)
pi510757 = pd.read_table("data/stable_ids/pi510757.assign_stable_IDs", names=header)
pi655972 = pd.read_table("data/stable_ids/pi655972.assign_stable_IDs", names=header)
RioNAM = pd.read_table("data/stable_ids/Rio.assign_stable_IDs", names=header)
...
all_genome_cds['testing_chineseamber.fasta'].keys()
#all_genome_cds['testing_chineseamber.fasta'].values()
    ...
    for index, row in pav_df.iterrows():
        ...
        if len(cds) > 0:
            ...
            for i in cds:
                ...
                for cds_name, sequence in all_genome_cds['testing_chineseamber.fasta'].items(): 
...
extracting_cds_name_and_length("ChiAmber")
