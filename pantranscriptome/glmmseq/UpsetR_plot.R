...
upset(fromList(listInput), keep.order = T, sets = c("Interaction", "Type", "Treatment"), order.by="freq", mainbar.y.label="DEGs Intersections", sets.x.label="DEGs Per Effect", text.scale=c(1.5, 1.5, 1.25, 1.25, 2, 2), sets.bar.color=c('steelblue','purple','orange'))
