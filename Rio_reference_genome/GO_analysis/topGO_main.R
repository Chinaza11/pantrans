...
# annot = read.table("GO_analysis/Rio_annotationInfo-reduced.txt", header=TRUE, stringsAsFactors = FALSE, sep="\t") 

annot = read.table("GO_analysis/Rio_annotationInfo-reduced_deduplicate.txt", header=TRUE, stringsAsFactors = FALSE, sep="\t") # this did not change previous GO result, seems topGO accounted for duplicates somehow
