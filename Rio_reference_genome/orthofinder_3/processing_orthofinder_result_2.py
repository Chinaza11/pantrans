...
annot = pd.read_csv('orthofinder_3/annot_node_ckpt5.csv')
annot['Species.Tree.Node_2'] = annot['Species.Tree.Node']

guide = {1:'N0', 2:'N1', 3:'N2', 4:'N3', 5:'N5', 6:'N7', 7:'N11', 8:'N13',
         9:'N15', 10:'N16', 11:'N17', 12:'sorghumRio'}
...
annot.to_csv('orthofinder_3/annot_node_ckpt6.csv', index=False)
