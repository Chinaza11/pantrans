...
# 13422 rows were annotated from Genes1 column of the Duplications.tsv file
# 13788 rows were annotated from Genes2 column of the Duplications.tsv file
# 622 genes were SingleCopyOrthologues
# 1356 genes were UnassignedGenes
# 34134 rows from orthogroup_from_orthogroups.tsv column + 1356 rows from UnassignedGenes column = 35490
...
# 21274 genes annotated (leaving 14216 not yet annotated)
