...
rio_type_df = read.table("Rio_reference_genome/GO_analysis/permutation/go_figure/permutation_type/molecular_function_result_permutation_type.tsv", header=TRUE, sep="\t")

rio_int_df = read.table("Rio_reference_genome/GO_analysis/permutation/go_figure/permutation_int/molecular_function_result_permutation_int.tsv", header=TRUE, sep="\t")
...
pant_type_df = read.table("pantranscriptome/GO_analysis/permutation/go_figure/permutation_type/molecular_function_result_permutation_type.tsv", header=TRUE, sep="\t")

pant_int_df = read.table("pantranscriptome/GO_analysis/permutation/go_figure/permutation_int/molecular_function_result_permutation_int.tsv", header=TRUE, sep="\t")
...
png(file="permutation/terms_treatment.png", width=16, height=10, units="in", res=300)
ggpubr::ggarrange(rio_treat_plot, pant_treat_plot,
                  ncol=2, nrow=1,
                  labels = "AUTO")
dev.off()

png(file="permutation/terms_type.png", width=16, height=10, units="in", res=300)
ggpubr::ggarrange(rio_type_plot, pant_type_plot,
                  ncol=2, nrow=1,
                  labels = "AUTO")
dev.off()

png(file="permutation/terms_interaction.png", width=16, height=10, units="in", res=300)
ggpubr::ggarrange(rio_int_plot, pant_int_plot,
                  ncol=2, nrow=1,
                  labels = "AUTO")
dev.off()

png(file="permutation/terms_all.png", width=16, height=10, units="in", res=300)
ggpubr::ggarrange(rio_treat_plot, pant_treat_plot,
